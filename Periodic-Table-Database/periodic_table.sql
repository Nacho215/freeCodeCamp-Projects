...
--
-- Name: elements uq_element_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements uq_element_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uq_element_symbol UNIQUE (symbol);
